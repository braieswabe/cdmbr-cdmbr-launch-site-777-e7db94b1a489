      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <textarea placeholder="Your Message" required className="border p-2 w-full" rows={4}></textarea>
            <button type="submit" className="bg-blue-600 text-white py-2 px-4">Send Message</button>
          </form>
        )}
      </div>
    </div>
